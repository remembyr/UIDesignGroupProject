          ...
          <div className="grid max-w-5xl grid-cols-2 items-center gap-10">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg leading-relaxed text-gray-500 dark:text-gray-400">
                Carbohydrates are found in foods like fruits, vegetables,
                breads, pastas, and grains. They can be categorized into simple
                carbs (sugars) and complex carbs (starches and fibers), both of
