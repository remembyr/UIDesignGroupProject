    ...
    <>
      ...
      <main className="flex min-h-screen items-center justify-center gap-2 dark:bg-gray-800">
        <div className="grid grid-cols-2 gap-20 max-w-5xl">
          ...
          <div>
            <h1 className="text-2xl dark:text-white">Drag the dining hall food to the plate if it's a good source of carbohydrates!</h1>
...
export default CarbsSortingGameSource;